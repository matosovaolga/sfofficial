...
export class SFServiceUxdesComponent {
  ...
  uxdes = [
    { id: 1, name: "UX/UI Research", text: "At Stableflow it is all about delivering stunning experiences and we achieve that we research and analyse various aspects of user interface design. Gathering requirements, audience analysis, online surveys we go lengths to achieve our design goals using the data we collect." },
    { id: 2, name: "HUMAN FACTOR ANALYSIS", text: "We make sure your websites are user friendly and thus human factor analysis is done at Stableflow to determine the necessary changes needed in designs. With this we take on to important factors such as icon size, sound, colour palate, and others to deliver nothing but the best." },
    ...
    { id: 5, name: "UX Evaluation", text: "At Stableflow we make sure your users are delivered with nothing less than awe-inspiring and thus we do a complete evaluation on the factors to understand how your websites and apps are being perceived graphically by your users. We do usability tests, content audit, expert reviews etc." }
  ]
  domains = [
