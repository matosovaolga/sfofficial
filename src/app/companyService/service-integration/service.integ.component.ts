...
export class SFServiceIntegComponent {
    ...
    textBanner: string = 'We will guide you throughout the process and help you build sound Service Oriented and Event Driven Architectures.';
   
  integrations = [
    {id: 1, name: "Backend Integration", text: "Stableflow helps you deliver a rich set of services by integrating new software with existing corporate back office systems. Depending on your needs, we can create a consolidated backend for disparate solutions or integrate specific backend elements of different applications into one another."},
