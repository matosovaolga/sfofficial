...
export class SFMobileAppsComponent {
  ...
  industries = [
    ...
    { id: 3, title: "Advertising", text: "We create Advertising Mobility apps for the advertising industry. Stableflow offers result oriented customised solutions for all." },
    ...
    { id: 5, title: "Media and Entertainment", text: "Stableflow develops quality mobility app for Media and Entertainment that caliber great creative results in terms of entertainment." },
